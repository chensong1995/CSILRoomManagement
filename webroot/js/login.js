/*
 * Author(s)  : Chen Song
 * Description: This client program for the login service
...
$(document).ready(function () {
    ...
    $("#password-signup-confirm").on('input', function() {
        ...
        if ($("#password-signup").val() == $("#password-signup-confirm").val() && $("#password-signup").val() != '') { // password and confirm match

            // create an icon and add it to the password textbox
            $("." + msgClass).attr("class", "has-feedback has-success " + msgClass);
            var icon = createIconWithClass(true, "password-confirm-icon");
            ...
            var icon = createIconWithClass(false, "password-confirm-icon");
            $("." + msgClass).append(icon);
